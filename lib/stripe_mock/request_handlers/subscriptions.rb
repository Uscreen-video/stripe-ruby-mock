    ...
    module Subscriptions
      ...
      def create_customer_subscription(route, method_url, params, headers)
        ...
        if api_version_supports_discounts?(headers)
          ...
          if params[:discounts]
            process_discounts_parameter(params, headers, subscription)
          end
        else
